...
% Our experiments with $g$, $r$, $i$ images that each
% contribute a similar amount of information showed relatively minor
% differences between the $\chipos^2$ method and our SED-matched
% methods, but for larger and more diverse data sets, the SED-matched
% methods automatically scale correctly, while the $\chipos^2$ method
% does not.
