...
\begin{figure}
    ...
    \end{center}
    \caption{The effect of the flux prior in Bayesian SED-matched
      source detection.  The exponential scale factor $\alpha$ affects
      the shape of the decision contours.  Decision contours for three
      different false-positive rates are shown ($10^{-1}$, $10^{-4}$
      and $10^{-7}$) for three different ``alpha'' values, with the
      three-SED model.  Notice that the largest ``alpha'' value has
