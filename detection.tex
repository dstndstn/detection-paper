...
\begin{figure}
  \begin{center}
    ...
    \caption{Bayesian SED-matched detection method compared to
      ...
      colors.  Still, since real images will often contain artifacts
      and moving objects, the fact that the $g+r+i$ \emph{prefers} these
      ...
      much higher flux than real sources.
      \label{fig:only}}
  \end{center}
\end{figure}
