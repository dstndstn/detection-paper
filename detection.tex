...
grid than the original image pixels.  We will see below (section
\secref{sec:multiimage}) that when combining multiple images, a
...
\changed{
In our Bayesian version of the SED-match filter, we assumed that the
