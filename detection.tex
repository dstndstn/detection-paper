\documentclass[11pt,letterpaper,preprint]{aastex63}

%%%%% TODO

% - fix Hogg's affiliations (Flatiron etc)
...
%such as the \emph{chi-squared coadd} (Szalay \emph{et al.} 1999), 
...
all provided helpful comments and discussion.
