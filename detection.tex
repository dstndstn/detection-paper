...
(including SourceExtractor, \cite{sourceextractor}), there is a notion of requiring more than
...
due to detector noise or a terrestrial artifact.  This is defined (eg, in \cite{unified_pastro}) as
\begin{eqnarray}
