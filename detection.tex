...
\begin{abstract}\noindent
  ...
  Detection in multi-band imaging involves making choices about the range of colors or spectral energy distributions to which the method will be most sensitive; we deliver methods based on Bayesian decision theory and frequentist methods that deliver similar outcomes in real-data tests.
