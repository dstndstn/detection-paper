...
We first present comparisons between the original $\chi^2$ method, the
$\chipos^2$ variant presented above, and two variants of SED-matched
...
\begin{figure}
  \begin{center}
    % from chi_squared_experiment.py
