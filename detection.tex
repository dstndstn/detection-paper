...
\begin{eqnarray}
  ...
  \snr{M_{\jvec}} &=& \frac{C_k \, \avec \cdot \bm{\psfat{j-k}}}{\sigma_1 \sqrt{\avec \cdot \avec}} \label{eqn:psfdotprod} \\
...
\begin{eqnarray}
  ...
  %\log P(\{ C_{\jvec} \} | F) &=& \sum_{\jvec} \log \frac{1}{\sqrt{2 \pi \sigma_1^2}} + \sum_{\jvec} -\frac{(C_{\jvec} - F \psf_{\jvec})^2}{2 \sigma_1^2} \\
  %\frac{\partial}{\partial F} \log P(\{ C_{\jvec} \} | F) &=& \sum_{\jvec} \frac{(C_{\jvec} - F \psf_{\jvec}) \psf_{\jvec}}{\sigma_1^2} \\
