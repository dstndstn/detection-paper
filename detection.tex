...
\begin{figure}[p!]
  ...
  \begin{center}
    %AAA
    % I DO NOT KNOW WTF THIS IS NEEDED BUT OTHERWISE THE SPACE IS ALL FUCKED UP
    \hspace{-1.5cm}
    \begin{tabular}{@{}c@{}c@{}c@{}c@{}c}
      & Chi-squared $\chi^2$ & Chi-positive $\chipos^2$ & SED (union) & SED (Bayes) \\
      \rheader{Chi-squared $\chi^2$} &
      \includegraphics[width=0.15\textwidth]{median-chisq} &
      \includegraphics[width=0.15\textwidth]{unmatched-chisq-chipos-9} &
      \includegraphics[width=0.15\textwidth]{unmatched-chisq-sed-union-9} &
      \includegraphics[width=0.15\textwidth]{unmatched-chisq-sed-mix-9} \\
      %
      %Chi-positive &
      \rheader{Chi-positive $\chipos^2$} &
      \includegraphics[height=0.15\textwidth]{unmatched-chipos-chisq-9} &
      \includegraphics[height=0.15\textwidth]{median-chipos} &
      \includegraphics[height=0.15\textwidth]{unmatched-chipos-sed-union-9} &
      \includegraphics[height=0.15\textwidth]{unmatched-chipos-sed-mix-9} \\
      %
      % SED union &
      \rheader{\hspace{1em}SED (union)} &
      \includegraphics[height=0.15\textwidth]{unmatched-sed-union-chisq-9} &
      \includegraphics[height=0.15\textwidth]{unmatched-sed-union-chipos-9} &
      \includegraphics[height=0.15\textwidth]{median-sed-union} &
      \includegraphics[height=0.15\textwidth]{unmatched-sed-union-sed-mix-9} \\
      %
      %SED mixture &
      \rheader{\hspace{1em}SED (Bayes)} &
      \includegraphics[height=0.15\textwidth]{unmatched-sed-mix-chisq-9} &
      \includegraphics[height=0.15\textwidth]{unmatched-sed-mix-chipos-9} &
      \includegraphics[height=0.15\textwidth]{unmatched-sed-mix-sed-union-9} &
      \includegraphics[height=0.15\textwidth]{median-sed-mix} \\
  \end{tabular}
  \end{center}
