...
\begin{figure}
  ...
  \caption{Sources detected by the different methods.  On the diagonal
    ...
    first (brighest) and last (faintest) 50 sources.  The off-diagonal images
    show sources that are detected by one method and not another method.
    }
\end{figure}
...
\begin{figure}
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Sources detected by one method and not another, in color-color space
    (in the single image in which source detection was performed).
    }
\end{figure}
...
\begin{figure}
  \begin{center}
    \begin{tabular}{ccccc}
      ...
      %Chi-squared &
      \raisebox{0.05\textwidth}{\rotatebox[origin=l]{90}{Chi-squared}} &
      \includegraphics[height=0.24\textwidth]{median-chisq} &
      \includegraphics[height=0.24\textwidth]{unmatched-chisq-chipos-9} &
      \includegraphics[height=0.24\textwidth]{unmatched-chisq-sed-union-9} &
      \includegraphics[height=0.24\textwidth]{unmatched-chisq-sed-mix-9} \\
      %
      %Chi-positive &
      \raisebox{0.05\textwidth}{\rotatebox[origin=l]{90}{Chi-positive}} &
      \includegraphics[height=0.24\textwidth]{unmatched-chipos-chisq-9} &
      \includegraphics[height=0.24\textwidth]{median-chipos} &
      \includegraphics[height=0.24\textwidth]{unmatched-chipos-sed-union-9} &
      \includegraphics[height=0.24\textwidth]{unmatched-chipos-sed-mix-9} \\
      %
      %SED union &
      \raisebox{0.05\textwidth}{\rotatebox[origin=l]{90}{SED union}} &
      \includegraphics[height=0.24\textwidth]{unmatched-sed-union-chisq-9} &
      \includegraphics[height=0.24\textwidth]{unmatched-sed-union-chipos-9} &
      \includegraphics[height=0.24\textwidth]{median-sed-union} &
      \includegraphics[height=0.24\textwidth]{unmatched-sed-union-sed-mix-9} \\
      %
      %SED mixture &
      \raisebox{0.05\textwidth}{\rotatebox[origin=l]{90}{SED mixture}} &
      \includegraphics[height=0.24\textwidth]{unmatched-sed-mix-chisq-9} &
      \includegraphics[height=0.24\textwidth]{unmatched-sed-mix-chipos-9} &
      \includegraphics[height=0.24\textwidth]{unmatched-sed-mix-sed-union-9} &
      \includegraphics[height=0.24\textwidth]{median-sed-mix}
    \end{tabular}
  \end{center}
  \caption{Sources detected by one method and not another: the median image
    in a deep coadd.
    }
\end{figure}
