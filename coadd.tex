...
\begin{document}
\title{
%  Things you always wanted to know about combining images \\
%  but were afraid to ask, part I: \\
%  Detecting point sources in heterogeneous collections of images
%  Things you always wanted to know (in astronomy) but were
%  afraid to ask:\\I: Detecting point sources in images}
...
%% Princeton University Observatory, 4 Ivy Lane, Princeton, NJ  08544}
%% \altaffiltext{\theaddress}{\stepcounter{address}\label{email} To whom
%% correspondence should be addressed: \texttt{dstn@astro.princeton.edu}}
...
%% \altaffiltext{\theaddress}{\stepcounter{address}\label{TheGood}
%% The Good}


\begin{abstract}
  Given a collection of images taken of the same patch of sky, it is
  ...
  intensity field; it is instead a heterogeneous significance map.  We
  ...
  priors.  After sources have been detected in the correct way
...
%%   Many astronomers know the correct procedures for detecting objects
%%   in images, co-adding images, and detecting objects in sets of
%%   images.  However, the mathematics behind these procedures, and the
%%   required assumptions about the data and the objects being detected,
%%   seem to be known less well.  This paper attempts to remedy this
%%   situation by walkings through the math and assumptions and deriving
%%   the rules of thumb that everyone know.
  
  % Many astronomers know facts about the correct ways to detect objects
  % in images, co-add images, and detect objects in sets of images.
  % Some of these known facts are correct, but \emph{why} they are so is
  % not always known with the same certainty as the facts themselves.
\end{abstract}
